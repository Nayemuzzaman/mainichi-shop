...
//  mainichi-shop
//
//  Created by Nayemuzzaman on 10/17/23.
//
...
class AddressController: UIViewController {
    ...
    var defaultLocation: CLLocationCoordinate2D = CLLocationCoordinate2DMake(37.33079800, -122.03072881)
    ...
    override func viewDidLoad() {
        ...
        self.centerMapToLocation(location: self.defaultLocation)
...
//        }
//
//        self.mkMapView.addAnnotation(places)
//    }
//}
...
extension AddressController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, regionDidChangeAnimated animated: Bool) {
        print("when region change call this function regionDidChangeAnimated")
    }
